    ...
    return function t(e, r, n) {
        ...
        1: [function (t, e, r) {
            ...
            function s(t, e, r) {
                ...
                var w = 0, x = [], S = {}, E = {}, T = !1, A = 0, k = new o.Parser({
            ...
            var o = t("htmlparser2"), a = t("xtend"), c = t("regexp-quote");
            e.exports = s;
            ...
            s.defaults = {
                ...
                return r = void 0 === r || r, e = e || {}, function (n, i) {
                    var s;
                    if (r) for (s in e) i[s] = e[s]; else i = e;
        ...
        2: [function (t, e, r) {
            ...
            function n() {
                for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", e = 0, r = t.length; e < r; ++e) c[e] = t[e], u[t.charCodeAt(e)] = e;
                u["-".charCodeAt(0)] = 62, u["_".charCodeAt(0)] = 63
            }

            function i(t) {
                var e, r, n, i, s, o, a = t.length;
                if (a % 4 > 0) throw new Error("Invalid string. Length must be a multiple of 4");
                s = "=" === t[a - 2] ? 2 : "=" === t[a - 1] ? 1 : 0, o = new h(3 * a / 4 - s), n = s > 0 ? a - 4 : a;
                var c = 0;
                for (e = 0, r = 0; e < n; e += 4, r += 3) i = u[t.charCodeAt(e)] << 18 | u[t.charCodeAt(e + 1)] << 12 | u[t.charCodeAt(e + 2)] << 6 | u[t.charCodeAt(e + 3)], o[c++] = i >> 16 & 255, o[c++] = i >> 8 & 255, o[c++] = 255 & i;
            ...
            function a(t) {
                for (var e, r = t.length, n = r % 3, i = "", s = [], a = 16383, u = 0, h = r - n; u < h; u += a) s.push(o(t, u, u + a > h ? h : u + a));
            ...
            var c = [], u = [], h = "undefined" != typeof Uint8Array ? Uint8Array : Array;
            n()
        }, {}],
        3: [function (t, e, r) {
        }, {}],
        4: [function (t, e, r) {
            (function (e) {
                ...
                r.alloc = function (t, e, r) {
                    ...
                    var a = new i(t);
                    if ("string" == typeof s) for (var c = new i(s, n), u = c.length, h = -1; ++h < t;) a[h] = c[h % u]; else a.fill(s);
                    return a
        ...
        5: [function (t, e, r) {
            (function (e) {
                ...
                function h(t, e) {
                    if (c(e), t = s(t, e < 0 ? 0 : 0 | g(e)), !o.TYPED_ARRAY_SUPPORT) for (var r = 0; r < e; ++r) t[r] = 0;
                    return t
                }
                ...
                function w(t, e, r, n, i) {
                    ...
                    if (i) {
                        var h = -1;
                        for (u = r; u < a; u++) if (s(t, u) === s(e, h === -1 ? 0 : u - h)) {
                            if (h === -1 && (h = u), u - h + 1 === c) return h * o
                        } else h !== -1 && (u -= u - h), h = -1
                    } else for (r + c > a && (r = a - c), u = r; u >= 0; u--) {
                        for (var l = !0, f = 0; f < c; f++) if (s(t, u + f) !== s(e, f)) {
                            l = !1;
                            break
                        }
                        if (l) return u
                ...
                function q(t, e, r) {
                    ...
                    for (var n = [], i = e; i < r;) {
                        var s = t[i], o = null, a = s > 239 ? 4 : s > 223 ? 3 : s > 191 ? 2 : 1;
                        if (i + a <= r) {
                            var c, u, h, l;
                            switch (a) {
                                case 1:
                ...
                var Z = t("base64-js"), K = t("ieee754"), $ = t("isarray");
                r.Buffer = o, r.SlowBuffer = _, r.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : n(), r.kMaxLength = i(), o.poolSize = 8192, o._augment = function (t) {
                    ...
                    for (var s = i - n, a = r - e, c = Math.min(s, a), u = this.slice(n, i), h = t.slice(e, r), l = 0; l < c; ++l) if (u[l] !== h[l]) {
                        s = u[l], a = h[l];
                        break
                    }
                ...
                o.prototype.slice = function (t, e) {
                    ...
                    if ("number" == typeof t) for (s = e; s < r; ++s) this[s] = t; else {
                        var a = o.isBuffer(t) ? t : F(new o(t, n).toString()), c = a.length;
        ...
        7: [function (t, e, r) {
            ...
            var u = t("domelementtype"), h = t("entities"), l = {
                __proto__: null,
                allowfullscreen: !0,
                async: !0,
                autofocus: !0,
        ...
        10: [function (t, e, r) {
            ...
            var i = t("domelementtype"), s = /\s+/g, o = t("./lib/node"), a = t("./lib/element"),
        ...
        11: [function (t, e, r) {
            var n = t("./node"), i = e.exports = Object.create(n), s = {tagName: "name"};
        ...
        15: [function (t, e, r) {
            ...
            var s = t("domelementtype"), o = r.isTag = s.isTag;
        ...
        17: [function (t, e, r) {
            ...
            function a(t, e) {
                for (var r = 0, n = e.length; r < n; r++) if (u(e[r]) && (t(e[r]) || e[r].children.length > 0 && a(t, e[r].children))) return !0;
                return !1
            }
            ...
            e.exports = {filter: n, find: i, findOneChild: s, findOne: o, existsOne: a, findAll: c}
        }, {domelementtype: 9}],
        18: [function (t, e, r) {
            function n(t, e) {
            ...
            var s = t("domelementtype"), o = t("dom-serializer"), a = s.isTag;
        ...
        20: [function (t, e, r) {
            var n = t("./lib/encode.js"), i = t("./lib/decode.js");
        ...
        21: [function (t, e, r) {
            function n(t) {
                var e = Object.keys(t).join("|"), r = s(t);
                e += "|#[xX][\\da-fA-F]+|#\\d+";
            ...
            var o = t("../maps/entities.json"), a = t("../maps/legacy.json"), c = t("../maps/xml.json"),
                u = t("./decode_codepoint.js"), h = n(c), l = n(o), f = function () {
                    function t(t) {
                        return ";" !== t.substr(-1) && (t += ";"), h(t)
                    }

                    for (var e = Object.keys(a).sort(i), r = Object.keys(o).sort(i), n = 0, c = 0; n < r.length; n++) e[c] === r[n] ? (r[n] += ";?", c++) : r[n] += ";";
                    var u = new RegExp("&(?:" + r.join("|") + "|#[xX][\\da-fA-F]+;?|#\\d+;?)", "g"), h = s(o);
                    return function (e) {
        ...
        23: [function (t, e, r) {
            ...
            var u = n(t("../maps/xml.json")), h = i(u);
            r.XML = a(u, h);
            var l = n(t("../maps/entities.json")), f = i(l);
            r.HTML = a(l, f);
        ...
        28: [function (t, e, r) {
            ...
            e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (t) {
                ...
                } else if (o(r)) for (s = Array.prototype.slice.call(arguments, 1), u = r.slice(), n = u.length, c = 0; c < n; c++) u[c].apply(this, s);
                return !0
        ...
        30: [function (t, e, r) {
            ...
            var c = t("./index.js"), u = c.DomHandler, h = c.DomUtils;
            t("inherits")(n, u), n.prototype.init = u;
            var l = function (t) {
                return "rss" === t || "feed" === t || "rdf:RDF" === t
            };
            n.prototype.onend = function () {
                var t, e, r = {}, n = s(l, this.dom);
        ...
        31: [function (t, e, r) {
            ...
            var i = t("./Tokenizer.js"),
                s = {input: !0, option: !0, optgroup: !0, select: !0, button: !0, datalist: !0, textarea: !0}, o = {
                    tr: {tr: !0, th: !0, td: !0},
                    th: {th: !0},
            ...
            t("inherits")(n, t("events").EventEmitter), n.prototype._updatePosition = function (t) {
                ...
                var e = t.search(c), r = e < 0 ? t : t.substr(0, e);
        ...
        34: [function (t, e, r) {
            ...
            e.exports = a;
            var c = t("entities/lib/decode_codepoint.js"), u = t("entities/maps/entities.json"),
                h = t("entities/maps/legacy.json"), l = t("entities/maps/xml.json"), f = 0, p = f++, d = f++, g = f++,
                _ = f++, m = f++, b = f++, y = f++, v = f++, w = f++, x = f++, S = f++, E = f++, T = f++, A = f++,
                k = f++, L = f++, q = f++, R = f++, C = f++, B = f++, D = f++, j = f++, N = f++, O = f++, M = f++,
                I = f++, P = f++, U = f++, H = f++, V = f++, z = f++, Y = f++, F = f++, G = f++, W = f++, X = f++,
                Q = f++, J = f++, Z = f++, K = f++, $ = f++, tt = f++, et = f++, rt = f++, nt = f++, it = f++, st = f++,
                ot = f++, at = f++, ct = f++, ut = f++, ht = f++, lt = f++, ft = f++, pt = f++, dt = 0, gt = dt++,
                _t = dt++, mt = dt++;
        ...
        35: [function (t, e, r) {
            function n(t, e) {
                var r = this._parser = new i(t, e), n = this._decoder = new o;
            ...
            e.exports = n;
            var i = t("./Parser.js"), s = t("stream").Writable || t("readable-stream").Writable,
                o = t("string_decoder").StringDecoder, a = t("buffer").Buffer;
        ...
        36: [function (t, e, r) {
            ...
            var i = t("./Parser.js"), s = t("domhandler");
            e.exports = {
                Parser: i,
        ...
        37: [function (t, e, r) {
            r.read = function (t, e, r, n, i) {
                var s, o, a = 8 * i - n - 1, c = (1 << a) - 1, u = c >> 1, h = -7, l = r ? i - 1 : 0, f = r ? -1 : 1,
                    p = t[e + l];
                ...
                var o, a, c, u = 8 * s - i - 1, h = (1 << u) - 1, l = h >> 1,
                    f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : s - 1, d = n ? 1 : -1,
                    g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        ...
        44: [function (t, e, r) {
            ...
            e.exports = n;
            var a = t("process-nextick-args"), c = t("core-util-is");
        ...
        46: [function (t, e, r) {
            (function (r) {
                ...
                function o(t, e, r, n, i) {
                    var s = h(e, r);
                    if (s) t.emit("error", s); else if (null === r) e.reading = !1, l(t, e); else if (e.objectMode || r && r.length > 0) if (e.ended && !i) {
                ...
                function E(t, e) {
                    var r = j.allocUnsafe(t), n = e.head, i = 1;
                ...
                e.exports = s;
                var q = t("process-nextick-args"), R = t("isarray");
                s.ReadableState = i;
                var C, B = (t("events").EventEmitter, function (t, e) {
                ...
                var D = t("buffer").Buffer, j = t("buffer-shims"), N = t("core-util-is");
                N.inherits = t("inherits");
                var O = t("util"), M = void 0;
                M = O && O.debuglog ? O.debuglog("stream") : function () {
                };
                var I, P = t("./internal/streams/BufferList");
                N.inherits(s, C);
                var U, U;
                ...
                s.prototype.read = function (t) {
                    ...
                    var d = (!e || e.end !== !1) && t !== r.stdout && t !== r.stderr, g = d ? s : o;
        ...
        47: [function (t, e, r) {
            ...
            e.exports = s;
            var a = t("./_stream_duplex"), c = t("core-util-is");
            ...
            (function (r) {
                ...
                function m(t, e) {
                    ...
                    if (t._writev && r && r.next) {
                        ...
                        for (; r;) {
                            var a = r.chunk, c = r.encoding, u = r.callback, h = e.objectMode ? 1 : a.length;
                ...
                var A, k = {deprecate: t("util-deprecate")};
                !function () {
                    try {
                        A = t("stream")
                    } catch (e) {
                ...
                var L = t("buffer").Buffer, q = t("buffer-shims");
                T.inherits(o, A);
                var R;
        ...
        56: [function (t, e, r) {
            ...
            var a = t("buffer").Buffer, c = a.isEncoding || function (t) {
