!function (t, e) {
    ...
    return function (t) {
        ...
        var i = r(1)["default"];
        e.__esModule = !0;
        var a = r(2), n = i(a), o = r(21), c = i(o), h = r(22), l = r(27), p = r(28), u = i(p), f = r(25), d = i(f),
            m = r(20), g = i(m), v = n["default"].create, y = s();
        ...
        e.__esModule = !0;
        var n = r(4), o = i(n), c = r(18), h = a(c), l = r(6), p = a(l), u = r(5), f = i(u), d = r(19), m = i(d),
            g = r(20), v = a(g), y = s();
        ...
        var m = "[object Object]";
        s.prototype = {
            constructor: s, logger: p["default"], log: p["default"].log, registerHelper: function (t, e) {
        ...
        var l = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;", "=": "&#x3D;"},
            p = /[&<>"'`=]/g, u = /[&<>"'`=]/, f = Object.prototype.toString;
        e.toString = f;
        var d = function (t) {
        ...
        var a = r(8), n = i(a), o = r(9), c = i(o), h = r(10), l = i(h), p = r(11), u = i(p), f = r(12), d = i(f),
            m = r(13), g = i(m), v = r(14), y = i(v)
    }, function (t, e, r) {
        "use strict";
        e.__esModule = !0;
        var s = r(5);
        ...
        e["default"] = function (t) {
            t.registerHelper("each", function (t, e) {
                ...
                if (e.data && e.ids && (l = i.appendContextPath(e.data.contextPath, e.ids[0]) + "."), i.isFunction(t) && (t = t.call(this)), e.data && (h = i.createFrame(e.data)), t && "object" == typeof t) if (i.isArray(t)) for (var p = t.length; o < p; o++) o in t && r(o, o, o === t.length - 1); else {
                    var u = void 0;
        ...
        function s(t) {
            var e = t && t[0] || 1, r = v.COMPILER_REVISION;
            if (e !== r) {
                if (e < r) {
                    var s = v.REVISION_CHANGES[r], i = v.REVISION_CHANGES[e];
        ...
        function i(t, e) {
            ...
            function s(e) {
                ...
                var a = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1], n = a.data;
            ...
            var i = {
                ...
                }, escapeExpression: d.escapeExpression, invokePartial: r, fn: function (e) {
                    var r = t[e];
        ...
        var r = function () {
            ...
            var e = {
                ...
                parse: function (t) {
                    ...
                    var r = this, s = [0], i = [null], a = [], n = this.table, o = "", c = 0, h = 0, l = 0;
        ...
        s.prototype = new l["default"], s.prototype.Program = function (t) {
            ...
            for (var s = t.body, c = 0, h = s.length; c < h; c++) {
                var l = s[c], p = this.accept(l);
                if (p) {
                    var u = i(s, c, r), f = a(s, c, r), d = p.openStandalone && u, m = p.closeStandalone && f,
        ...
        s.prototype = {
            compiler: s, equals: function (t) {
                ...
                if (e.knownHelpers = {
                    ...
                    log: !0,
                    lookup: !0
                }, r) for (var s in r) s in r && (e.knownHelpers[s] = r[s]);
                ...
                var e = f["default"].helpers.simpleId(t.path), r = e && !!this.blockParamIndex(t.path.parts[0]),
                    s = !r && f["default"].helpers.helperExpression(t), i = !r && (s || e);
                if (i && !s) {
        ...
        i.prototype = {
            nameLookup: function (t, e) {
                ...
                var t = o.COMPILER_REVISION, e = o.REVISION_CHANGES[t];
                return [t, e]
                ...
                var e = this.environment.isSimple, r = !this.forceBuffer, s = void 0, i = void 0, a = void 0,
                    n = void 0;
                ...
                var s = this.popStack(), i = this.setupHelper(t, e), a = r ? [i.name, " || "] : "",
                    n = ["("].concat(a, s);
                ...
                var r = this.popStack();
                this.emptyHash();
                var s = this.setupHelper(0, t, e), i = this.lastHelper = this.nameLookup("helpers", t, "helper"),
                    a = ["(", "(helper = ", i, " || ", r, ")"];
                ...
                var e = ["("], r = void 0, i = void 0, a = void 0;
                ...
                var s = [], i = this.setupHelperArgs(e, t, s, r), a = this.nameLookup("helpers", e, "helper"),
