...
public class RedisRaterLimiter {
    ...
    static final Logger log = LoggerFactory.getLogger(RedisRaterLimiter.class);
    ...
    public String acquireTokenFromBucket(String point, int limit, long timeout) {
        ...
        try {
            ...
            //为每个有序集分别指定一个乘法因子(默认设置为1)每个成员的score值在传递给聚合函数之前都要先乘以该因子
